...
```{r}
cor.test(data = o_sex, ~ masse + taille_cr, alternative = "greater")

```

```{r}
cor.test(data = o_sex, ~ masse + taille, alternative = "greater")
```
...
lm1. %>.%
  ...
  labs(x = "Masse (g)", y= "Taille de la cellule radiale (mm)")
